...
| Median kappa | 3.83 |
| IQR | 6.92 |
| kappa < 1 (broadly tuned) | 5,211 (22.1%) |
| kappa 1-5 (moderate) | 8,785 (37.2%) |
| kappa 5-10 (sharp) | 4,849 (20.6%) |
| kappa >= 10 (very sharp) | 4,744 (20.1%) |
...
3. **Most neurons are well-described by the von Mises model.** With median R2 = 0.750 and 77.6% of neurons having R2 > 0.5, the single-peaked von Mises model captures the tuning of most neurons. The 9.4% with R2 < 0.3 likely include neurons with weak or complex (e.g., multi-peaked) orientation responses.
